...
class AddRefrigerant(openstudio.measure.EnergyPlusMeasure):
    ...
    def arguments(self, workspace: openstudio.Workspace):
        ...
        Objects_for_replacement.setDescription("Select the objects for which the refrigerant should be replaced with new refrigerant")
        Objects_for_replacement.setDefaultValue("Refrigeration:System")
    ...
    def run(
        ...
        """ Replace the capacity and power curves of the compressor based on casewalkins temperature"""
