...
- **FluidPropertiesRefData_R448a.idf** – Refrigerant property dataset for R448A.  
- **FluidPropertiesRefData_R449a.idf** – Refrigerant property dataset for R449A.  
- **R448A449A_MT_LT_Curves.idf** – Compressor performance curves for R448A and R449A (medium- and low-temperature applications).
- **test_add_refrigerant.py** – Unit tests that validate argument parsing, refrigerant data import, and replacement logic using sample models.  
